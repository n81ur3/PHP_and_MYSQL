    ...
    if (empty($errors)) {
        ...
        if (mysqli_num_rows($r) == 0) {
            ...
            if (mysqli_affected_rows($dbc) == 1) {
                ...
                echo '<p class="error">The user could not be edited due to a system error. We apologize for an inconvenience</p>';
                //Debugging message
...
if (mysqli_num_rows($r) == 1) { //valid user ID, show the form
    ...
    echo '<p class="error">This page has been accessed in errror</p>';
}
